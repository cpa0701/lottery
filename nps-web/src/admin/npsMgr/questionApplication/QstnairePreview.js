...
import InitQuestionList from '../questionPreview/InitQuestionList'

import '../questionPreview/questionPreview.less'

class QstnairePreview extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
...
export default QstnairePreview;
